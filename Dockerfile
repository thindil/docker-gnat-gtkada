...
RUN apt-get update && apt-get install -y \
 ...
 libsm-dev \
 libice-dev \
 && wget -q "https://community.download.adacore.com/v1/8d4bb21f8122cd0796c6aab3541326e2d3bcda0d?filename=gtkada-2020-x86_64-linux-bin.tar.gz" \
  -O /tmp/gtkada-2020-x86_64-linux-bin.tar.gz \
